...
class Assignment(db.Model):
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        assertions.assert_valid(_id is not assignment.teacher_id)
    ...
    @classmethod
    def get_all_submiited_and_graded_assignment(cls):
        submitted_assignments = cls.filter(cls.state.in_([AssignmentStateEnum.SUBMITTED,AssignmentStateEnum.GRADED]))
